      ...
      <%@ taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql" %>
        ...
        <body>
          <% response.addHeader("Pragma", "no-cache" );
            ...
            if(session.getAttribute("authorid")!=null) { } else { response.sendRedirect("AuthorLogin.jsp"); } int
            book_id=Integer.parseInt(request.getParameter("bookid")); session.setAttribute("book_id", book_id); %>
            ...
            <div class="container">
              <form action="AddProcess2.jsp" method="post">
                <br>
