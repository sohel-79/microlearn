<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
  ...
  <body>
    ...
    <% int book_id=Integer.parseInt(request.getParameter("bookid")); session.setAttribute("book_id", book_id); %>
        ...
        <div class="row">
          <c:forEach var="card" items="${rs.rows}">
            <div class="col-12 col-md-6 col-sm-6 col-lg-3">
              <div class="card text-white bg-dark mb-3" id=book style="width: 20rem;">
                <div class="card-body">
...
" />
                  ...
                  <a href="Deleteidea.jsp?ideaid=${card.id}" class="btn btn-primary">Delete Idea</a>
                  <a href="Editidea.jsp?ideaid=${card.id}" class="btn btn-primary">Edit Idea</a>
                  <p />
                </div>
              </div>
            </div>
