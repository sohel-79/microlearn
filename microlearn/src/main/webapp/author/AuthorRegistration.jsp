<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
  ...
  <head>
    ...
    <link rel="stylesheet" href="../css/author/registration.css">
  ...
  <body>
    ...
    <div class="row no-gutters">
      <div class="col-12 col-sm-12 col-md-6 d1 ">
        ...
        <form action="AuthorRegistrationVerification.jsp" method="post">
          <br>
        ...
        <br>
        <br>
        <form action="AuthorLogin.jsp">
          <input type="submit" value="Login">
        </form>
      </div>

      <div class="col-md-6 d-none d-md-flex">
        <a href="https://www.vecteezy.com/free-vector/content-writer"><img class="img-fluid"
            src="../images/registration/authorRegistration.jpg"></a>
      </div>
